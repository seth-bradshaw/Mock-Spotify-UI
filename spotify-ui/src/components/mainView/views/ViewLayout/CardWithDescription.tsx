...
export default function CardWithDescription({ imgSrc, label, description, handleClickPlay = null, handleRedirect, spotify_uri }: Props) {
  ...
  return (
    <div className="basis-1/6 bg-spotify-gray-800 rounded-lg flex flex-col justify-start text-base p-4 pb-5 gap-4 hover:bg-spotify-gray-650 hover:cursor-pointer overflow-hidden relative group h-min" onClick={handleRedirect}>
